package emerge.project.mrsolution_admin.ui.adapters.assing_products;
 ...
 */
public class AssignedProductSubAdapter extends RecyclerView.Adapter<AssignedProductSubAdapter.MyViewHolder> {
    ...
    public AssignedProductSubAdapter(Context mContext, ArrayList<Products> item) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_assigned_products_sub, parent, false);
