package emerge.project.mrsolution_admin.ui.adapters.visits;
...
import emerge.project.mrsolution_admin.ui.activity.visits.VisitsPresenter;
import emerge.project.mrsolution_admin.ui.activity.visits.VisitsPresenterImpli;
import emerge.project.mrsolution_admin.ui.activity.visits.VisitsView;
...
public class VisitsAdapter extends RecyclerView.Adapter<VisitsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.textviewRep.setText(visit.getRepName());
