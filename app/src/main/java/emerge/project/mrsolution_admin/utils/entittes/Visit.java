package emerge.project.mrsolution_admin.utils.entittes;
...
public class Visit implements Serializable {
    ...
    public Visit(int id, String code, String visitNumber, int locationID, String location, int doctorID, String doctorName, int repID, String repName, String comment,
                 String visitDate, Double latitude, Double longitude, ArrayList<VisitProducts> visitsProduct, boolean isProductExpaind,String imageUrl) {
        this.id = id;
        this.code = code;
